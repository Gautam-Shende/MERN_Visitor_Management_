...
export const fetchPasses = () => api.get('/pass').then(res => res.data);


export const fetchPassById = (id) => api.get(`/pass/${id}`).then(res => res.data);


export const createPass = (appointmentId) => api.post(`/pass/${appointmentId}`).then(res => res.data);
...
export const fetchCheckLogsByPassId = (passId) => 
