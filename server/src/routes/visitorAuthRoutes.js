...
import {
  ...
  requestAppointment,getMyRequests
} from "../controllers/auth/visitorAuthController.js";

import {
  getMyAppointments, getVisitorDashboard,
  getMyPasses, getPassByAppointment,
...
// router.get("/api/visitor/dashboard", getVisitorDashboard);
